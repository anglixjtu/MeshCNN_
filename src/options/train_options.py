...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--num_aug', type=int,
                                 default=1, help='# of augmentation files')
        self.parser.add_argument('--print_freq', type=int, default=10,
                                 help='frequency of showing training results on console')
        self.parser.add_argument('--save_latest_freq', type=int,
                                 default=250, help='frequency of saving the latest results')
        ...
        self.parser.add_argument(
            '--bidirectional', action='store_false', help='bidirectional chamfer loss or not')
        self.parser.add_argument(
            '--reverse', action='store_true', help='reverse chamfer loss or not')
